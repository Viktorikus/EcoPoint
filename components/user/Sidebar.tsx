...
export default function UserSidebar() {
  ...
  const menuItems = [
    ...
    { label: "Setor Sampah", icon: "♻️", path: "/dashboard/deposit" },
    { label: "Penjemputan", icon: "🚗", path: "/dashboard/pickup" },
    { label: "Laporan", icon: "📋", path: "/dashboard/report" },
    { label: "Rewards", icon: "🎁", path: "/dashboard/rewards" },
    { label: "Leaderboard", icon: "🏆", path: "/dashboard/leaderboard" },
    { label: "Profil", icon: "👤", path: "/dashboard/profile" },
  ]
    ...
    <div className={`${jakarta.className} w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col shadow-sm`}>
      ...
      <div className="p-4 border-t border-gray-200 space-y-3">
        <div className="bg-gray-50 rounded-lg p-3">
          ...
          <p className="text-xs text-[#16A34A] font-medium">{user?.points || 0} Poin</p>
        </div>
        <button
